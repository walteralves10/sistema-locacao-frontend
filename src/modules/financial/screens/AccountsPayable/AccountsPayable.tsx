...
export default function AccountsPayable() {
    ...
    return (
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Contas a pagar</h2>

            <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    <div className="col-span-2">
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Plano de conta</label>
                        <div className="mt-1 flex">
                            ...
                            >
                                ...
                                <option value="expenses-01">Expenses - 01</option>
                                <option value="expenses-02">Expenses - 02</option>
                            </select>
                    ...
                    <div>
                        ...
                        <div className="mt-1 flex">
                            ...
                            >
                                <option value="">-- select --</option>
                                <option value="cc-01">CC 01</option>
                            </select>
                            <button type="button" className="ml-2 px-3 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-500">Gerenciar</button>
                        </div>
                    </div>
